...
public class ABMCostoFijo extends javax.swing.JFrame {

    Controlador controlador;
    private TableRowSorter trsFiltro;
    List<CostoFijo> listCostoFijo;
    
    public ABMCostoFijo(Controlador controlador, List<CostoFijo> listCostoFijo) {
        this.controlador = controlador;
        initComponents();
        cargarCostoFijo(listCostoFijo);
        this.listCostoFijo=listCostoFijo;
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CódigoCostoFijo", "Nombre", "Descripcion", "Pesos"
            }
        ) {
        ...
        jLabelCodigo.setText("Codigo Costo: ");
    ...
    private void botonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonModificarActionPerformed
        ...
        int codigo = (int) jTable1.getValueAt(row,0);
         CostoFijo costoFijo= controlador.modificarCostoFijo(codigo);
     //    ModificarAtributosCostoFijo modificarAtributos  = new ModificarAtributosCostoFijo(controlador,costoFijo);
...
//////
    private void botonBajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBajaActionPerformed
        ...
        controlador.bajaCF(codigo);
                    List<CostoFijo> listCostoFijo = controlador.iniciarCostoFijo();
dispose();
            ABMCostoFijo  Gui_NuevaAbm = new ABMCostoFijo(controlador, listCostoFijo);
...
public  void cargarCostoFijo(List<CostoFijo> listCostoFijo){
        
 DefaultTableModel dtm= (DefaultTableModel) jTable1.getModel();
           
dtm.setRowCount(0);       
  for(int i=0 ;i< listCostoFijo.size();i++ ){
            
                dtm.addRow(new Object[]{
                    listCostoFijo.get(i).getCodigoCostoFijo(),
                    listCostoFijo.get(i).getNombreCostoFijo(),
                    listCostoFijo.get(i).getDescripcionCostoFijo(),
                    listCostoFijo.get(i).getPesos()
...
int existe=0;
        ...
        else
        {
            ...
            for (int i = 0; i < listCostoFijo.size(); i++) {
                if(listCostoFijo.get(i).getCodigoCostoFijo()== codigo){
                    existe=1;
                dialogoNombreEnBlanco.setSize(300,150);
                dialogoNombreEnBlanco.setLocation(100, 100);
                dialogoNombreEnBlanco.setVisible(true);
            ...
            if(existe==0){
            int pesos = (int)Integer.parseInt(jTextPrecio.getText());
            String descripcion = jTextDescripcionMP.getText();
    
            CostoFijo costoFijo = new CostoFijo(codigo, nombre, pesos, descripcion);

            controlador.altaCostoFijo(costoFijo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ABMCostoFijo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ABMCostoFijo().setVisible(true);
            }
        });
    }
